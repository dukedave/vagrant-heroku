...
tar jxf ruby-1.9.3-p547.tar.bz2
cd ruby-1.9.3-p547
...
# Install RubyGems 1.8.23.2
wget http://production.cf.rubygems.org/rubygems/rubygems-1.8.23.2.tgz
tar xzf rubygems-1.8.23.2.tgz
cd rubygems-1.8.23.2
/opt/ruby/bin/ruby setup.rb
cd ..
rm -rf rubygems-1.8.23.2*
